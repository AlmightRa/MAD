...
class RouteManagerForts(RouteManagerBase):
    ...
    def __init__(self, db_wrapper, coords, max_radius, max_coords_within_radius, path_to_include_geofence,
                 ...
                 name="unknown"):
        logger.debug ( "__init__RouteManagerForts" )
        ...
        logger.debug ( "__init__RouteManagerForts base called" )

    def _retrieve_latest_priority_queue(self):
        logger.debug ( "_retrieve_latest_priority_queue" )
        return None
    ...
    def _get_coords_post_init(self):
        result = self.db_wrapper.gyms_from_db(self.geofence_helper)
        logger.debug("_get_coords_post_init")
        return result
        # return self.db_wrapper.gyms_from_db(self.geofence_helper)

    def _cluster_priority_queue_criteria(self):
        logger.debug ( "_cluster_priority_queue_criteria" )
    ...
    def _start_routemanager(self):
        logger.debug ( "_start_routemanager" )
    ...
    def _check_coords_before_returning(self, lat, lng):
        logger.debug ( "_check_coords_before_returning" )
        return True
